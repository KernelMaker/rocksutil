...
class SequentialFileReader {
 ...
 public:
  ...
  SequentialFileReader(SequentialFileReader&& o) ROCKSUTIL_NOEXCEPT {
    *this = std::move(o);
  }

  SequentialFileReader& operator=(SequentialFileReader&& o) ROCKSUTIL_NOEXCEPT {
...
class RandomAccessFileReader {
 ...
 public:
  ...
  RandomAccessFileReader(RandomAccessFileReader&& o) ROCKSUTIL_NOEXCEPT {
    *this = std::move(o);
  }

  RandomAccessFileReader& operator=(RandomAccessFileReader&& o) ROCKSUTIL_NOEXCEPT{
    file_ = std::move(o.file_);
    return *this;
  }
...
extern Status NewWritableFile(Env* env, const std::string& fname,
                              ...
                              const EnvOptions& options);
extern Status NewRandomAccessFile(Env* env, const std::string& fname,
                              unique_ptr<RandomAccessFile>* result,
                              const EnvOptions& options);
extern Status NewSequentialFile(Env* env, const std::string& fname,
